...
export class UserService {
  ...
  dashbaord1(instituteId: string): any {
    return this.http.post<{
      success: string,
      message: string,
      info: any;
    }>(
      API_URL + '/dashboard_row_one', ''
    );
  }
  dashbaord2(instituteId: string): any {
    return this.http.post<{
      success: string,
      message: string,
      info: any;
    }>(
      API_URL + '/dashboard_row_two', ''
    );
  }
  dashbaord3(instituteId: string): any {
    return this.http.post<{
      success: string,
      message: string,
      info: any;
    }>(
      API_URL + '/dashboard_row_three', ''
    );
  }
  dashbaord4(instituteId: string): any {
    return this.http.post<{
      success: string,
      message: string,
      info: any;
    }>(
      API_URL + '/dashboard_row_four', ''
    );
  }
  // dashbaord5(instituteId: string): any {
  //   return this.http.post<{
  //     success: string,
  //     message: string,
  //     info: any;
  //   }>(
  //     API_URL + '/dashboard_row_five', ''
  //   );
  // }
