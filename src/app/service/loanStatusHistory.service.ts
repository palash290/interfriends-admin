...
import { LoanStatusHistory } from '../model/loanStatusHistory.model';


const API_URL = environment.apiUrl;
@Injectable({ providedIn: 'root'})

export class loanStatusHistoryService {

  private lists: LoanStatusHistory[] = [];
  private listsUpdated = new Subject<{ lists: LoanStatusHistory[]; listCount: number;}>();
