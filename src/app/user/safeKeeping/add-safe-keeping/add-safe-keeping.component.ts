...
@Component({
  selector: 'app-add-safe-keeping',
  templateUrl: './add-safe-keeping.component.html',
  styleUrls: ['./add-safe-keeping.component.css']
})
export class AddSafeKeepingComponent implements OnInit {
