...
@Component({
  selector: 'app-help-to-pay-car-insurane',
  templateUrl: './help-to-pay-car-insurane.component.html',
  styleUrls: ['./help-to-pay-car-insurane.component.css']
})
export class HelpToPayCarInsuraneComponent implements OnInit {
