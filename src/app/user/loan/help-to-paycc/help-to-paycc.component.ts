...
@Component({
  selector: 'app-help-to-paycc',
  templateUrl: './help-to-paycc.component.html',
  styleUrls: ['./help-to-paycc.component.css']
})
export class HelpToPayccComponent implements OnInit {
