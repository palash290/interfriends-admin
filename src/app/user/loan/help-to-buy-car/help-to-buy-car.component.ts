...
@Component({
  selector: 'app-help-to-buy-car',
  templateUrl: './help-to-buy-car.component.html',
  styleUrls: ['./help-to-buy-car.component.css']
})
export class HelpToBuyCarComponent implements OnInit {
